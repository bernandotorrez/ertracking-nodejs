...
function fsGetDataOrafin(param, callback) {
  ...
  soap.createClientAsync(url).then((client) => {
    ...
    client.fsGetDataOrafin(args, function (err, result, rawResponse, soapHeader, rawRequest) {
      ...
      if(result.error.ERROR || typeof result.error.ERROR !== 'undefined') {
        callback_data = {
          'PR_NUMBER': '',
          'ER_NUMBER': '',
          'pr_date': '',
      ...
      } else if(typeof result.RequestERPR === 'undefined') {
        callback_data = {
          'PR_NUMBER': '',
          'ER_NUMBER': '',
          'pr_date': '',
...
function fsGetDataERMultibranch(param, callback) {
  ...
  soap.createClientAsync(url).then((client) => {
    ...
    } else if(typeof result.ResponseERMultibranch === 'undefined') {
        callback_data = {
            'ER_NUMBER': '',
            'BENEFICIARY': '',
            'ACCOUNT_NUMBER': '',
