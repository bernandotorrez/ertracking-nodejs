    ...
    success: function (response) { // Ketika proses pengiriman berhasil
      ...
      if (response.status == "success" && response.tipe == 'biasa') { // Jika isi dari array status adalah success
        ...
        if (tipe_ws == 'BT') {
          ...
          $('#spasi-er-bt-lampiran').show()
        } else {
          $('#hide_pr_po_bt').show()
          $('#show_lampiran_dibayarkan').hide()
          $('#spasi-er-bt-lampiran').hide()
        }

        //$("#txt_noerpr").val(response.txt_noerpr);

        $("#htxt_validator1").val(response.txt_validator1);
        $("#htxt_validator2").val(response.txt_validator2);
        $("#htxt_checker").val(response.txt_checker);
        $("#htxt_tipeer").val(response.txt_tipeer);
        $("#htxt_branchid").val(response.txt_branchid);
        ...
        $("#htxt_appdate").val(response.txt_appdate);
        $("#htxt_erdate").val(response.txt_erdate);
        $("#htxt_prdate").val(response.txt_prdate);
        $("#htxt_accdate").val(response.txt_accdate);
        ...
        $('#txt_er_bt').val(response.txt_er_bt);
        $('#txt_lampiran').val(response.txt_lampiran);
  ...
  $("#txt_checkermb").change(function () {
    ...
    $.ajax({
      ...
      success: function (result) {
        ...
        $('#id_checkermb').val(json.id_checker);
        $('#id_validator1mb').val(json.id_validator1);
        $('#id_validator2mb').val(json.id_validator2);
